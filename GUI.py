...
# create blank window
window = Tk()
window.title("Autgenerate Anomali Report")
...
btn1 = Button(window, text = "Upload MER", fg = "black", command = clicked, font = ("Arial",15))
btn2 = Button(window, text = "Upload EMPS", fg = "black", command = clicked, font = ("Arial",15))
btn3 = Button(window, text = "Upload Downtime Detail", fg = "black", command = clicked, font = ("Arial",15))
...
openfiles = Button(window, text = "OpenFiles",  fg = "black", command = openfile, font = ("Arial",20))
...
openfiles2 = Button(window, text = "OpenFiles2",  fg = "black", command = openfile2, font = ("Arial",20))
openfiles2.grid(column = 0, row = 10)

# ask for a directory
def openfile3():
    filedialog.askdirectory()
openfiles3 = Button(window, text = "Ask Directory",  fg = "black", command = openfile3, font = ("Arial",20))
